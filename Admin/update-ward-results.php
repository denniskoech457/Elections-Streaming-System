					...
					<p><a href="index.php">home</a> / UPDATE RESULTS</p>
						<div class="module">
							...
							<?php
                                ...
                                $ward_id = $_GET['ward_id']; // get id through query string
                                // Get records from the database
                                $askdetails = $db->query("SELECT * FROM candidates where candidate_id='$candidate_id' AND ward_id='$ward_id' ");
									...
									<form class="form-horizontal row-fluid" action="" method="POST">
										...
										<div class="control-group">
											...
											<div class="controls">
                                                ...
                                                <input type="hidden" name="ward_id" value="<?php echo $details['ward_id']; ?>" id="">
											</div>
										</div>
										...
										<div class="control-group">
											<div class="controls">
												<button type="submit" name="updatewardresults" class="btn">Update ward Election Results</button>
											</div>
										</div>
									</form>
							</div>
