                    ...
                    <div class="span9">
                        <div class="content"> 
                            <div class="module-head">
								...
								<a href="add-positions.php?type_id=<?php echo $type= $_GET['type_id']; ?>" class="btn btn-primary">+ ADD POSITIONS</a>
							</div>
                            <br>
                            <hr>
                                ...
                                <?php
                                        ...
                                        ?>
                                            ...
                                            <div class="btn-box big span4">
                                                <a href="results.php?position=<?php echo $elecresults['position']; ?>&type_id=<?php echo $type= $_GET['type_id']; ?>" ><i class="icon-group"></i>
                                                    <p class="text-muted">
                                                    <?php echo $elecresults['position']; ?></p>
                                                </a>
                                                <br>
                                                <br>
                                                <a class="btn btn-danger" href="delete-position.php?position_id=<?php echo $elecresults['position_id']; ?>&election_id=<?php echo $type= $_GET['type_id']; ?>">Delete</a>
                                            </div>
